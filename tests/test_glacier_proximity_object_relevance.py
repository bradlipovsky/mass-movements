...
class RelevanceTests(unittest.TestCase):
    ...
    def test_canonical_manifest_and_exact_set_are_mandatory(self):
        ...
        self.assertEqual(len(PRE_FILES), 8)
    ...
    def test_projection_repair_is_identified_and_bounded(self):
        ...
        self.assertTrue(fixed.is_valid); self.assertEqual((record["rgi_id"], record["cell_key"]), ("test-id", "test-cell")); self.assertLessEqual(record["relative_area_change"], 1e-8)
    def test_join_state_and_group_conservation(self):
        ...
        self.assertTrue(cells.cell_state.eq("no_absent_object_intersects_conservative_screen").all())
